...
public class MathFragment extends LoadoutFragment implements KeyboardExtenderActionReceiver
{
	
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		super.onCreate(savedInstanceState);
		final View rootView = inflater.inflate(R.layout.math, container, false);
		
		// this.application = (KeyboardExtender) this.getApplication();
		
		mainView = (android.support.v7.widget.GridLayout) rootView.findViewById(R.id.math_grid);
		...
		vto.addOnGlobalLayoutListener(new OnGlobalLayoutListener()
		{
			...
			public void onGlobalLayout()
			{
				...
				android.support.v7.widget.GridLayout gl = (android.support.v7.widget.GridLayout) rootView.findViewById(R.id.math_grid);
