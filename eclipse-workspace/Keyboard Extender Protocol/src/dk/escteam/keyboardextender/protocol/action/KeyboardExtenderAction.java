package dk.escteam.keyboardextender.protocol.action;
...
public abstract class KeyboardExtenderAction
{
	...
	public static KeyboardExtenderAction parse(DataInputStream dis) throws IOException
	{
